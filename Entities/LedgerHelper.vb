...
Public Class LedgerHelper
    ...
    Public Sub AddLedgerDetail(ByVal str As String)
        Dim saveQuery = "INSERT INTO " + InstitutionMasterData.XInstType + "_Ledger([Lgr_Fin_Yr],[Lgr_Seq_No],[Lgr_Inst_Cd],[Lgr_Inst_Typ],[Lgr_Brn_Cd ],[Lgr_Lnk_No],[Lgr_Dbk_Cd],[Lgr_Trn_Typ],[Lgr_Vch_No],[Lgr_Vch_Ref_No],[Lgr_Narr],[Lgr_Ref_No],[Lgr_Acc_Cd],[Lgr_Amt],[Lgr_Cr_Dr],[Lgr_ABS_Amt],[Lgr_Ent_By],[Lgr_Ent_Dt],[Lgr_Upd_By],[Lgr_Upd_Dt],[Lgr_Conf_By],[Lgr_Conf_Dt])" + _
           " SELECT VD_Fin_Yr,VD_Seq_No,VD_Inst_Cd,VD_Inst_Typ,VD_Brn_Cd,VD_Lnk_No,VD_Dbk_Cd,VD_Trn_Typ ,VD_Vch_No ,VD_Vch_Ref_No ,VD_Narr,VD_Ref_No,VD_Acc_Cd,VD_Amt,VD_Cr_Dr,VD_ABS_Amt,'" + InstitutionMasterData.XUsrId + "',GETDATE(),'" + InstitutionMasterData.XUsrId + "',GETDATE(),'" + InstitutionMasterData.XUsrId + "',GETDATE() from dbo." + InstitutionMasterData.XInstType + "_Voucher_Detail where VD_Lnk_No='" + str + "'"
